      ...
      <div className="had-wrap relative pt-24 md:pt-32 pb-20 md:pb-28">
        <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div className="anim-fade-up">
            <span className="had-eyebrow mb-8 inline-flex">HAD · Method · v0.1</span>
            <h1 className="had-display text-foreground" style={{ fontSize: "clamp(48px, 7.5vw, 116px)" }}>
              Human-Governed{" "}
              <span className="text-warm italic font-display font-normal">Agentic</span>{" "}
              Delivery
            </h1>
            <p className="mt-8 max-w-xl text-lg md:text-xl text-ink-2 leading-relaxed">
              A new open method for delivering digital value with AI agents under human governance.
            </p>
            <div className="mt-7 py-4 border-y had-hairline flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-[11px] uppercase tracking-[0.16em] text-ink-2">
              <span className="flex items-center gap-2"><Dot color="warm" /> Humans govern</span>
              <span className="flex items-center gap-2"><Dot color="accent" /> Agents conceive</span>
              <span className="flex items-center gap-2"><Dot color="accent2" /> AI delivers</span>
              <span className="flex items-center gap-2"><Dot color="good" /> Value validates</span>
            </div>
            <div className="mt-9 flex flex-wrap gap-3 items-center">
              ...
              >
                <Download className="size-4 mr-2" /> Download the HAD Starter Kit
              </Button>
              <Button asChild variant="outline" className="rounded-none h-12 px-6 border had-hairline-2 hover:border-ink font-mono text-[12px] uppercase tracking-[0.12em] bg-transparent">
                <Link to="/generator">Configure your AI tool <ArrowRight className="size-4 ml-2" /></Link>
              </Button>
              <Link
                to="/community"
            ...
            <div className="mt-16 grid grid-cols-3 border-t had-hairline">
              <Stat k="Method version" v="v0.1" />
              <Stat k="Artifacts" v="08" />
              <Stat k="Toolkits" v="09" />
            </div>
          </div>
